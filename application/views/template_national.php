					...
					<div class="span8">
						<div id="top_menu">
							<div class="welcome_msg">
								...
								<br>
								<span class="date"><?php echo date('l, jS F Y')
									?></span>
...
if($this->session->userdata("message_user_update_success")){
		...
		<div id="msg_user_update">
			<?php  echo $this -> session -> userdata("message_user_update_success");?>
		</div>
		<?php
		...
		<div class="left-content" style="float: left">
			...
			<ul id="notification1" class="nav nav-list well">
				<li>
					<a id='online' class='admin_link'><i class='icon-signal'></i>Online Facilities <div id="span2" class='badge badge-important'></div></a>
				</li>
				<li>
					<a id='inactive' class='admin_link'><i class='icon-th'></i>Deactivated Users <div id="span1" class='badge badge-important'></div></a>
				</li>
			</ul>
		</div>
		<?php
